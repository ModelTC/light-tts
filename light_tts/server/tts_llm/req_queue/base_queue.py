...
from light_tts.server.core.objs import FinishStatus
from light_tts.utils.config_utils import get_fixed_kv_len
...
class BaseQueue:
    def __init__(self, args, router, dp_index, dp_size_in_node) -> None:
        ...
        from light_tts.server.tts_llm.manager import RouterManager
