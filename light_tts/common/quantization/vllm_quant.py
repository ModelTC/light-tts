...
from light_tts.common.quantization.triton_quant.fp8.fp8act_quant_kernel import per_token_group_quant_fp8
from light_tts.common.quantization.triton_quant.fp8.fp8w8a8_block_gemm_kernel import w8a8_block_fp8_matmul

try:
    HAS_VLLM = True
    from light_tts.common.vllm_kernel import _custom_ops as ops
except:
    HAS_VLLM = False
...
class vLLMBaseQuantizationMethod(QuantizationMethod):
    def __init__(self):
        ...
        from light_tts.common.basemodel.layer_infer.cache_tensor_manager import g_cache_manager
